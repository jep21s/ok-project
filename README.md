...
Пользователю не нужно с нуля разрабатывать базовые функции. Он может использовать движок «как есть» и 
реализовать только графический интерфейс (UI), либо дополнительно добавить собственную бизнес-логику, 
если это необходимо для его конкретного решения.
